...
import com.example.moodyapp.audio.AudioRecorder
        ...
        val chatCompletionRequest = ChatCompletionRequest(
            ...
            messages = listOf(
                ChatMessage(
                    ...
                    content = "Eres un asistente de psicologia especializado en resumir texto de manera extremadamente concisa y eficaz"
                ),
                ChatMessage(
                    role = ChatRole.User,
    ...
    fun generateLogo(
        ...
        try {
            ...
            if (masked) {
                ...
                images = openAI.imageURL( // or openAI.imageJSON
                    ImageEdit(
                    image = FileSource(
